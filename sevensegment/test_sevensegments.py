...
class SevenSegmentTest(unittest.TestCase):
    ...
    def test_last_digit_to_turn_on_or_off_display(self):
        ...
        self.assertTrue(self.sevensegment.is_on(binary_letters))
        binary_letters = "11111110"
        self.assertFalse(self.sevensegment.is_on(binary_letters))

    def test_convert_string_to_array_of_integers(self):
        binary_letters = "11111111"
        converted_array = self.sevensegment.convert_string_to_array_of_integers(binary_letters)
    ...
    def test_display_seven_segment_when_display_is_on(self):
        binary_letters = "11111111"
        converted_array = self.sevensegment.convert_string_to_array_of_integers(binary_letters)
        display = self.sevensegment.create_display_array(converted_array)
